...
from product_model import ProductPaths, find_slots, safe_filename, stage_is_current
...
class ProductUnitTests(unittest.TestCase):
    ...
    def test_content_based_plan_has_no_fixed_minimum(self):
    ...
    def test_prepare_is_resumable_and_chinese_path_safe(self):
        with tempfile.TemporaryDirectory(prefix="软著 测试 ") as temp:
            ...
            state = project / "软件著作权申请资料/.工作区/workflow-state.json"
